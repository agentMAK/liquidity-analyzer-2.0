import { Box, Flex, Td, Text, tokenToCSSVar } from "@chakra-ui/react";
...
const TokenLiquidityContainer = ({
  ...
  {tokenTVL.isLoading ? <Box>Loading</Box> :
      <MaxTradeTable tokenAddress={tokenAddress} exchanges={Object.keys(tokenTVL.data)}/>
      }
    </Box>
  );
};
